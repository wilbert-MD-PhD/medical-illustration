...
[轻量预览（0.52 MB）](preview-light.pdf) · [完整PDF（30.05 MB）](review.pdf) · [逐幅解剖图与参考对应](#解剖结构如何对应真实参考) · [来源与许可](CREDITS.md) · [机器可读输入清单](reference-map.json) · [返回主页](../../../README.md)
...
- 阅读：高质量PDF保留矢量文字；轻量预览PDF包含当前医生示例的六页及矢量文字，仅压缩图片，约0.52 MB；它是阅读副本，不是编辑源文件。逐页图片与PDF均为v1.1。
